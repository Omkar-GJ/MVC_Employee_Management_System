...
public boolean insertEmp(Employee smc) throws IOException, ClassNotFoundException{
		...
		int SMCount=0;
	   	...
	   	//If File is open here It Gives EOFException in viewAllEmp() during Reading the object
	   	
	   	if(EmpAl.isEmpty())
	   	{
	   		
	   		FileOutputStream fos=new FileOutputStream("D:/STUDY/Study/Java/EmployeeSalaryManagemant/src/Data1.txt",false);
		   	ObjectOutputStream oos= new ObjectOutputStream(fos);
	   		//System.out.println("Is Empty "+smc);
	   		EmpAl.add(smc);
	   	...
	   	else
	   	{
	   		...
	   		if(isFound==false)
   			{
   				...
   				FileOutputStream fos=new FileOutputStream("D:/STUDY/Study/Java/EmployeeSalaryManagemant/src/Data1.txt",false);
   			   	ObjectOutputStream oos= new ObjectOutputStream(fos);
   				//System.out.println("Not Empty"+smc);
   				EmpAl.add(smc);
   		   		oos.writeObject(EmpAl);
   		   		SMCount++;
   		   		oos.close();
...
public boolean removeEmployee(int id) throws ClassNotFoundException
	{
       ...
       try {
    	   ...
    	   for(Employee e:Erem)
    	   {
    		   ...
    		   {
    			  // System.out.println("To REMOVE fOUND : "+e);
